...
export function HomePage() {
    return(
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 mb-6">
                            <h3 className="mb-4 nav-name">Danh sách sản phẩm</h3>
                        </div>
                    </div>
                                ...
                                <div className="card-body">
                                    <div className="text-center position-relative ">
                                        ...
                                        <a href="tam-store/src/components#!">
                                            {" "}
                                            <img
                                                src="https://sohanews.sohacdn.com/2018/10/13/photo-1-15393957361321034636421.jpg"
                                    ...
                                    <div className="text-small mb-1">
                                        <a href="tam-store/src/components#!" className="text-decoration-none text-muted">
                    ...
                    $24
                                        ...
                                        <div>
                                            <a href="tam-store/src/components#!" className="btn btn-success btn-sm">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width={16}
                                                    height={16}
            ...
            {/*                        />*/}
            {/*                    </div>*/}
            {/*                    <h3 className="h5 mb-3 mt-3">10 minute grocery now</h3>*/}
            {/*                    <p>*/}
            ...
            {/*                        />*/}
            {/*                    </div>*/}
            {/*                    <h3 className="h5 mb-3 mt-3">Best Prices &amp; Offers</h3>*/}
            {/*                    <p>*/}
            ...
            {/*                        />*/}
            {/*                    </div>*/}
            {/*                    <h3 className="h5 mb-3 mt-3">Wide Assortment</h3>*/}
            {/*                    <p>*/}
            ...
            {/*            /!*                    <div class="mb-6"><img src="https://sohanews.sohacdn.com/2018/10/13/photo-1-15393957361321034636421.jpg" alt=""></div>*!/*/}
            ...
            <div className="border-top py-4 container">
                <div className="row align-items-center me-5">
                    <div className="col-md-6">
        <span className="small text-muted ">
          Copyright 2022 © therichpost eCommerce Template. All rights reserved.
          Powered by <a href="https://therichpost.com/">Tạp hoá Tâm</a>.
        </span>
                    </div>
                    <div className="col-md-6 pe-3">
                        <ul className="list-inline text-md-end mb-0 small mt-3 mt-md-0">
                            ...
                            <li className="list-inline-item me-1">
                                <a href="tam-store/src/components#!" className="icon-shape icon-sm social-links ">
                                    {" "}
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={16}
